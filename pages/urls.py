...
from .views import home, hospitals, register_hospital, hospital_page, donors_list, register_donation, use_blood_hospital, loginPage, logoutUser, search_for_blood, search_for_blood_result
