...
class Hospital(models.Model):
    ...
    op = models.IntegerField(default=0,null=True)
    on = models.IntegerField(default=0,null=True)
    ap = models.IntegerField(default=0,null=True)
    an = models.IntegerField(default=0,null=True)
    bp = models.IntegerField(default=0,null=True)
    bn = models.IntegerField(default=0,null=True)
    abp = models.IntegerField(default=0,null=True)
    abn = models.IntegerField(default=0,null=True)
